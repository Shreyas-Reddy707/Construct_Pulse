...
interface WorkerAttendanceLogProps {
  workerId: string;
}

const attendanceConfig: DataTableConfig = {
...
export function WorkerAttendanceLog({ workerId }: WorkerAttendanceLogProps) {
  const { data, isLoading, isError, refetch } = useAttendanceHistory(workerId);
